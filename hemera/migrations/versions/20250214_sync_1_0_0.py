...
from sqlalchemy import NUMERIC, BOOLEAN, INTEGER, VARCHAR, ARRAY, BIGINT, TIMESTAMP
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint('transaction_hash', 'block_timestamp', 'block_number', 'log_index', 'block_hash', 'token_id', name='nft_transfers_pkey')
    )
